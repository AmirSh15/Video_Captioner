...
def process(
    ...
    video: torch.Tensor or None = None,
    text: str or list[str] or None = None,
) -> BatchEncoding:
...
class VideoBlipVisionModel(Blip2VisionModel):
    ...
    def forward(
        self,
        pixel_values: torch.FloatTensor or None = None,
        output_attentions: bool or None = None,
        output_hidden_states: bool or None = None,
        return_dict: bool or None = None,
    ) -> tuple or BaseModelOutputWithPooling:
